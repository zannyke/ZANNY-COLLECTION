...
import { Mail, Lock, ArrowRight, UserPlus, Eye, EyeOff, ArrowLeft } from 'lucide-react';
...
export default function CustomerLogin() {
  ...
  return (
    <div className="auth-page-container" style={{ minHeight: '100vh', display: 'flex', background: '#fff', fontFamily: 'var(--font-body)' }}>
      ...
      {/* Right side: Form */}
      <div className="login-form-container" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
        <button 
