...
export default function AdminLogin() {
  ...
  return (
    <div style={{
      ...
      background: '#0e0e0e', fontFamily: 'var(--font-body)',
    }}>
      <motion.div
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-heading)', color: '#fff', fontSize: '1.4rem', letterSpacing: '3px' }}>
            ZANNY ADMIN
          </h1>
          <p style={{ color: '#555', fontSize: '0.75rem', letterSpacing: '1px', marginTop: '0.3rem' }}>
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div>
            <label style={{ display: 'block', color: '#888', fontSize: '0.7rem', letterSpacing: '1.5px', textTransform: 'uppercase', marginBottom: '0.5rem' }}>
              Admin Password
            </label>
            <input
              type="password"
              ...
              style={{
                ...
                background: '#111', border: `1px solid ${error ? '#c0392b' : '#2a2a2a'}`,
                color: '#fff', outline: 'none', fontSize: '1rem',
                fontFamily: 'var(--font-body)', boxSizing: 'border-box',
                transition: 'border-color 0.2s',
              }}
              onFocus={e => e.target.style.borderColor = '#555'}
              onBlur={e => e.target.style.borderColor = error ? '#c0392b' : '#2a2a2a'}
            />
        ...
        <p style={{ color: '#333', fontSize: '0.7rem', textAlign: 'center', marginTop: '2rem' }}>
