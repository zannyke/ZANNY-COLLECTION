...
export default function Footer() {
  return (
    <footer className="footer-container" style={{ backgroundColor: '#111', color: '#fff' }}>
      <div className="container footer-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', marginBottom: '2.5rem' }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
            <img src="/zanny_collection_icon.png" alt="Zanny Icon" style={{ width: '28px', height: '28px', objectFit: 'contain' }} />
      ...
      <style>{`
        .footer-container { padding: 3.5rem 0 1.5rem; }
        .footer-grid { gap: 2.5rem; }
        .footer-link:hover { color: #fff; transition: color 0.3s; }
        
        @media (max-width: 768px) {
          .footer-container { padding: 2.5rem 0 1.5rem; }
